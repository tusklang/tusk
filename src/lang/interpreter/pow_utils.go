...
func number__pow__integer(val1, val2 OmmType, cli_params CliParams, line uint64, file string) OmmType {
...
func ln(val OmmType, cli_params CliParams, line uint64, file string) OmmType {
  x := val.(OmmNumber)
...
func fac(val OmmType, cli_params CliParams, line uint64, file string) OmmType {
  x := val.(OmmNumber)
  ensurePrec(&x, &OmmNumber{}, cli_params)
...
func exp(val OmmType, cli_params CliParams, line uint64, file string) OmmType {
  x := val.(OmmNumber)
  ensurePrec(&x, &OmmNumber{}, cli_params)

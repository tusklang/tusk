  ...
  for i := 0; i < len_lex; i++ {
    ...
    switch lex[i].Name {
      ...
      case "each":
        ...
        actions = append(actions, Action{ "each", "", []string{ var1, var2 }, actionized, []string{}, iterator, []Condition{}, 59, []Action{}, []Action{}, []Action{}, [][]Action{}, [][]Action{}, make(map[string][]Action), false })
